...
GBL.CHANGELOG_DATA = {
    ...
    {"0.41.5", "2026-09-24", {
        Fixed = {
            ...
            "The Restock row says what is on its way and what is in doubt separately, each with its own age. A row holding both read 15 bought, result unknown over the whole figure, which put a purchase that had already succeeded in doubt along with the one that had not, and the age shown was the oldest purchase on that item, so something bought seconds ago could say it was bought hours ago and send you to an empty mailbox.",
    ...
    {"0.41.0", "2026-09-21", {
        ...
        Fixed = {
            ...
            "The Restock tab's grey row annotations and the Layout tab's hints under the bulk row read the accessible palette instead of a low-contrast grey.",
    ...
    {"0.39.0", "2026-09-07", {
        ...
        Fixed = {
            ...
            "The sort preview no longer shows a bag slot as a bank tab. An item the sort could not place read as a negative tab number in the Unplaced list while every other line called the same slot Bag0/5.",
