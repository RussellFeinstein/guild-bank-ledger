...
-- inner-tab switches. Mouse-wheel events have to land on a ScrollFrame
-- inside the inner tab's content frame (an outer ScrollFrame around
-- the TabGroup does not receive them reliably).
