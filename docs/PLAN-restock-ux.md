...
change) shipped 2026-09-22 as v0.41.1: the frame's OnShow and OnHide redraw the tab in IDLE and
READY, installed lazily because Auctionator creates the frame on the first Auction House show;
the hook goes with the precondition at #194. #218 (a countdown on the PRICED banner) follows.
