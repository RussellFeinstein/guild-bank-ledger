...
**UI** (v0.3.0--v0.20.0):
- 6-tab interface: Transactions, Gold Log, Consumption, Sync, Changelog, About
...
| v1.5.0 | **Export** | CSV, Discord Markdown, BBCode; filter-aware copy-to-clipboard from Transactions, Gold Log, Consumption |
