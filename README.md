...
- **UI window** — Tabbed interface with Transactions, Gold Log, Consumption, Sync, and Changelog views, opened via `/gbl` or minimap button
...
- CSV/Discord/BBCode export (v0.21.0)
