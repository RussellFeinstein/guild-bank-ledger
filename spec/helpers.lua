...
function Helpers.loadAddon()
    ...
    safeDofile("src/BankLayout.lua")
    safeDofile("src/SortPlanner.lua")
    safeDofile("src/SortExecutor.lua")
    safeDofile("src/RestockCategories.lua")
    safeDofile("src/Restock.lua")
    -- UI modules (M3+)
